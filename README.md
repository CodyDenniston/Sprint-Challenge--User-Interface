...
Semantic HTML is the information you see on the screen. The words, without the style. 

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display: inline; will line up all of the objects in a row, whereas display: block will block the flow of the website and push everything below it.
...
Git allows developers to retrieve their code from the past, in case something messes up and they need to backtrack.
